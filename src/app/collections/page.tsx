  ...
  return (
    <main className="min-h-screen bg-brand-white">
      ...
      <section className="mx-auto max-w-7xl px-4 md:px-8 lg:px-16 py-12">
        <StaggerContainer staggerDelay={0.08} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            ...
            return (
              <StaggerItem key={col.id} variant="fade-up">
                <Link
                  ...
                  className="group flex flex-col gap-3 border border-brand-light/40 rounded-2xl p-4 bg-brand-white hover:-translate-y-1.5 hover:shadow-lg transition-all duration-300 transform-gpu"
                >
                  {/* Image */}
                  <div
