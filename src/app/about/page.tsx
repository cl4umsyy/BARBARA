    ...
    <main className="w-full bg-brand-white text-brand-black pb-24 font-sans">
      ...
      <section className="bg-brand-light/25 border-y border-brand-light/35 py-20">
        <div className="mx-auto max-w-7xl px-4 md:px-8 lg:px-16">
          <StaggerContainer staggerDelay={0.15} className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <StaggerItem variant="fade-up">
              <div className="bg-brand-white border border-brand-light/35 p-8 rounded-3xl shadow-sm flex flex-col gap-4 hover:-translate-y-1 transition-transform duration-300">
        ...
        <StaggerContainer staggerDelay={0.08} className="grid grid-cols-2 lg:grid-cols-4 gap-6">
          {stats.map((stat, idx) => (
            <StaggerItem key={idx} variant="zoom-in">
              <div
                className="bg-brand-white border border-brand-light/35 p-6 rounded-2xl shadow-sm text-center flex flex-col gap-2 transition-all duration-300 hover:-translate-y-1 hover:shadow-md"
              >
      ...
      <section className="bg-brand-light/10 border-t border-brand-light/20 py-20">
        <div className="mx-auto max-w-7xl px-4 md:px-8 lg:px-16">
          ...
          <StaggerContainer staggerDelay={0.08} className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-8">
      ...
      <section className="mx-auto max-w-7xl px-4 py-20 md:px-8 lg:px-16">
        ...
        <StaggerContainer staggerDelay={0.12} className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {team.map((member, idx) => (
            <StaggerItem key={idx} variant="fade-up">
              <div
                className="bg-brand-white border border-brand-light/35 p-4 rounded-3xl shadow-sm flex flex-col gap-4 group hover:-translate-y-1.5 hover:shadow-lg transition-all duration-300"
              >
        ...
        <ScrollReveal variant="zoom-in">
          <div className="bg-brand-black text-brand-white p-8 md:p-16 rounded-[32px] text-center flex flex-col items-center justify-center gap-6 relative overflow-hidden shadow-lg">
            ...
            <div className="relative z-10">
              <Link
                href="/shop"
                className="inline-flex items-center gap-2 px-8 py-4 bg-brand-white text-brand-black text-xs font-black uppercase tracking-widest rounded-2xl hover:bg-brand-light hover:scale-105 active:scale-95 transition-all shadow-md group cursor-pointer"
              >
                Jelajahi Produk
